...
class Transaccion(Base):
    ...
    codigo_tipo_producto = Column(
        "CODIGOTIPOPRODUCTO",
        String(50),
        ForeignKey("FINANCIERO.TIPO_PRODUCTO.CODIGO"),
        nullable=False,
    )
    codigo_tipo_producto_forma_pago = Column(
        "CODIGOTIPOPRODUCTOFORMAPAGO",
        String(50),
        ForeignKey("FINANCIERO.TIPO_PRODUCTO.CODIGO"),
        nullable=False,
    )
    codigo_tipo_canal_sbs = Column(
        "CODIGOTIPOCANALSBS",
        String(10),
        ForeignKey("FINANCIERO.TIPO_CANAL_SBS.CODIGO"),
        nullable=False,
    )
    id_generador_contable = Column(
        "IDGENERADORCONTABLE",
        Integer,
        ForeignKey("CONTABILIDAD.GENERADOR_CONTABLE.ID"),
        nullable=False,
    )
    ...
    transaccion_ahorros = relationship("TransaccionAhorros", back_populates="transacciones")

    # Dos FKs hacia TIPO_PRODUCTO: especifica foreign_keys en ambos lados
    # tipo_producto = relationship(
    #     "TipoProducto",
    #     foreign_keys=[codigo_tipo_producto],
    #     back_populates="transacciones_por_producto",
    # )
    # tipo_producto_forma_pago = relationship(
    #     "TipoProducto",
    #     foreign_keys=[codigo_tipo_producto_forma_pago],
    #     back_populates="transacciones_por_forma_pago",
    # )

    # tipo_canal_sbs = relationship(
    #     "TipoCanalSBS",
    #     back_populates="transacciones"
    # )
    # generador_contable = relationship(
    #     "GeneradorContable",
    #     back_populates="transacciones"
    # )