...
class Deposito(Base):
    ...
    codigo_tipo_deposito = Column('CODIGOTIPODEPOSITO', NVARCHAR(20), ForeignKey('INVERSION.TIPO_DEPOSITO.CODIGO'), nullable=False)
    ...
    codigo_estado_deposito = Column('CODIGOESTADODEPOSITO', NVARCHAR(10), ForeignKey('INVERSION.ESTADO_DEPOSITO.CODIGO'), nullable=False)
    ...
    codigo_tipo_firma = Column('CODIGOTIPOFIRMA', NVARCHAR(50), ForeignKey('INVERSION.TIPO_FIRMADPF.CODIGO'), nullable=False)
