...
class AsesorPrestamoCambio(Base):
    ...
    usuario_origen = relationship("Usuario", foreign_keys=[codigo_usuario_origen])
    usuario_destino = relationship("Usuario", foreign_keys=[codigo_usuario_destino])
    usuario_registro = relationship("Usuario", foreign_keys=[codigo_usuario])
