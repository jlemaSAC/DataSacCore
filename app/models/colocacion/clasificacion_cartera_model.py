...
class ClasificacionCartera(Base):
    ...
    codigo_calificacion_contable = Column('CODIGOCALIFICACIONCONTABLE', String(30), ForeignKey('CREDITO.CALIFICACION_CONTABLE.CODIGO'), nullable=False)
    ...
    codigo_tipo_vencimiento = Column('CODIGOTIPOVENCIMIENTO', String(10), ForeignKey('COLOCACION.TIPO_VENCIMIENTO.CODIGO'), nullable=False)
