...
class PrestamoCalificacionProviciones(BaseSecundaria):
    ...
    __table_args__ = (
        ...
        {"schema": "COLOCACION"},   # importante: esquema es COLOCACION (dentro de SAC_PROVICIONES)
    )
    ...
    id_calificacion_prestamo_informacion = Column(
    ...
    id_calificacion_prestamo_informacion_original = Column(
        "IDCALIFICACIONPRESTAMOINFORMACIONORIGINAL",
        Integer,
        nullable=False,
    )
