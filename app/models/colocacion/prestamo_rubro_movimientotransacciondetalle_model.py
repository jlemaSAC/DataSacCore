...
class PrestamoRubroMovimientoTransaccionDetalle(Base):
    ...
    id_movimiento_transaccion_detalle = Column(
        "IDMOVIMIENTOTRANSACCIONDETALLE", Integer,
    ...
    # rubro = relationship("Rubro", back_populates="movimientos_rubro")
    # forma_pago = relationship("FormaPago", back_populates="movimientos_rubro")
    # detalle_transaccion = relationship("MovimientoTransaccionDetalle", back_populates="movimientos_rubro")
    # estado = relationship("EstadoPrestamoRubro", back_populates="movimientos_rubro")