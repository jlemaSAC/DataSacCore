...
class InversionItemInversion(Base):
    ...
    id_inversion = Column('IDINVERSION', Integer, ForeignKey('PORTAFOLIO.INVERSIONPORTAFOLIO.ID'), nullable=False)
    id_item_inversion = Column('IDITEMINVERSION', Integer, ForeignKey('PORTAFOLIO.ITEMINVERSION.ID'), nullable=False)
    codigo_estado = Column('CODIGOESTADO', NVARCHAR(5), ForeignKey('PORTAFOLIO.ESTADOITEMINVERSION.CODIGO'), nullable=False)
