...
class TipoCuenta(Base):
    ...
    # Relaciones (opcional, declara los modelos referenciados si los usas)
    cuentas = relationship("Cuenta",back_populates="tipos_cuenta")
    empresa = relationship("Empresa", back_populates="tipos_cuenta")
    
    # empresa = relationship("Empresa", backref="tipos_cuenta")
    # producto = relationship("Producto", backref="tipos_cuenta")
    # tipo_riesgo_sarf = relationship("TipoRiesgoSARF", backref="tipos_cuenta")
    # tipo_producto_sarf = relationship("TipoProductoSARF", backref="tipos_cuenta")

    # Si mapeas AHORROS.CUENTA con FK a TIPO_CUENTA(CODIGO),
    # puedes habilitar esta relación inversa:
