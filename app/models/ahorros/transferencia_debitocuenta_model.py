...
class TransferenciaDebitoCuenta(Base):
    ...
    id_transferencia = Column('IDTRANSFERENCIA', Integer, ForeignKey('AHORROS.TRANSFERENCIA.ID'), primary_key=True, nullable=False)
    numero_cuenta_debito = Column('NUMEROCUENTADEBITO', NVARCHAR(50), ForeignKey('AHORROS.CUENTA.NUMERO'), nullable=False)
