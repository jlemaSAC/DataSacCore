...
class DepreciacionAgenciaDetalle(Base):
    ...
    id_depreciacion_agencia = Column('IDDEPRECIACIONAGENCIA', Integer, ForeignKey('ACTIVOFIJO.DEPRECIACION_AGENCIA.ID'), nullable=False)
    ...
    porcentaje_depreciacion_periodo = Column('PORCENTAJEDEPRECIACIONPERIODO', Numeric(18, 2), nullable=False)
    porcentaje_depreciacion_acumulada = Column('PORCENTAJEDEPRECIACIONACUMULADA', Numeric(18, 2), nullable=False)
    ...
    fecha_inicio_calculo = Column('FECHAINICIOCALCULO', DateTime, nullable=False, server_default=text('getdate()'))   
