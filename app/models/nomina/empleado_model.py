...
class Empleado(Base):
    ...
    persona_natural = relationship("PersonaNatural",back_populates="empleados")
    # agencia_departamento = relationship("AgenciaDepartamento", backref="empleados")
    # cargo = relationship("Cargo", backref="empleados")
    usuario = relationship("Usuario", back_populates="empleados")
    # funcionario = relationship("Funcionario", backref="empleado", uselist=False)