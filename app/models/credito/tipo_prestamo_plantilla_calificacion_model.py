...
class TipoPrestamoPlantillaCalificacion(Base):
    __tablename__ = "TIPO_PRESTAMO_PLANTILLACALIFICACION"
    ...
    codigo_plantilla = Column('CODIGOPLANTILLA', NVARCHAR(30), ForeignKey('CREDITO.PLANTILLA_CALIFICACION.CODIGO'), nullable=False)
