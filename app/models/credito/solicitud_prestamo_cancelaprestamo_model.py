...
class SolicitudPrestamoCancelaPrestamo(Base):
    ...
    # solicitud_prestamo = relationship("SolicitudPrestamo", back_populates="cancelaciones")
    prestamos = relationship("Prestamo", back_populates="cancelaciones_solicitudes")