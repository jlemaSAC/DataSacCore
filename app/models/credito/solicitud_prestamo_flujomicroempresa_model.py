...
class SolicitudPrestamoFlujoMicroempresa(Base):
    ...
    id_microempresa = Column('IDMICROEMPRESA', Integer, ForeignKey('CLIENTES.MICROEMPRESA.ID'), nullable=False)
    codigo_tipo_periodo = Column('CODIGOTIPOPERIODO', NVARCHAR(10), ForeignKey('CREDITO.TIPO_PERIODO.CODIGO'), nullable=False)
