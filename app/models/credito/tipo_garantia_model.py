...
class TipoGarantia(Base):
    ...
    codigo_cuenta_orden_deudora = Column('CODIGOCUENTAORDENDEUDORA', NVARCHAR(50), ForeignKey('CONTABILIDAD.CUENTACONTABLE.CODIGO'), nullable=False)
    codigo_cuenta_orden_acreedora = Column('CODIGOCUENTAORDENACREEDORA', NVARCHAR(50), ForeignKey('CONTABILIDAD.CUENTACONTABLE.CODIGO'), nullable=False)
